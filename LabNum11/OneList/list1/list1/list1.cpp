...
List* create_list()
{
    ...
    for (int i = 1; i < N; i++)
    {
        ...
        node->next = NewNode;                          // Создание указателя на следующий элемент
...
void AddOneElemIndex(int i) // Не нужна?
{
...
void AddKElemIndex(int pos, int k)
{
    ...
    else
    {
        ...
        elem->next = nullptr; // разрыв сарой связи
...
void print_menu() {
    ...
    cout << "1. Создать односвязный список." << endl << endl;
